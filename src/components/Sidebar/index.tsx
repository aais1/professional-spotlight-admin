...
import { faCalendar, faComment, faPerson, faUser } from '@fortawesome/free-solid-svg-icons';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <FontAwesomeIcon icon={faUser} className='text-bodydark2 dark:text-white' />
                  Portfolios
                </NavLink>
              </li>
              {/* <!-- Menu Item Calendar --> */}
              ...
              <li>
                <NavLink
                  ...
                  onClick={handleNavLinkClick}
                >
                  <FontAwesomeIcon icon={faComment} className=' text-body1  text-bodydark dark:text-white' />
                  Reviews
                </NavLink>
              </li>
              <li>
                <NavLink
                  ...
                  onClick={handleNavLinkClick}
                >
                  <FontAwesomeIcon icon={faHourglassHalf} className='  text-bodydark dark:text-white' />
                  Approve Reviews
                </NavLink>
              </li>
              {/* <!-- Menu Item Tables --> */}
